      ...
      <>
        {sections[0].type === 11 ? (
          <div className="w-full mb-4">
            <Carousel className='carousel' autoplay={true} show={2}>
              {sections[0].articles.map((item, i) => {
                return (
                  <a
                    href={item.url.url}
                    className="place-content-center btn-main-offer"
                    key={i}
                  >
                    <img
                      className="img w-full h-96 bg-contain bg-center z-0"
                      src=""
                    />
          ...
          <>
            {sections[0].type === 6 && sections[0].articles.length > 2 ? (
              <div className="w-full mb-4">
                <Carousel className='carousel' show={2} duo>
                  {sections[0].articles.map((item, i) => {
                    return (
                      <a href={item.url.url} className="w-full px-1" key={i}>
                        <img
                          className="img w-full h-40 bg-contain bg-center"
                          src={
  ...
  return (
    <>
      {sections[0].articles.length >= 2 ? (
        <div className="w-full mb-4">
          <Carousel className='carousel' autoplay={true} show={1}>
            {sections[0].articles.map((item, i) => {
              return (
